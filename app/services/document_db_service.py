...
def process_event(event_data: dict):
    ...
    outgoing_event["payload"]["inserted"] = inserted # True if new document was stored, False if it was a duplicate
    outgoing_event["payload"]["doc_id"] = f"doc_{image_id}" # This is a made-up document ID for demonstration. In a real MongoDB setup, this would be the ObjectId generated by MongoDB when the document is inserted.
